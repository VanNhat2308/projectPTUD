...
public class ChiTietPhongPanel extends JPanel implements ActionListener, MouseListener {
	...
	public ChiTietPhongPanel() {
		...
		lbGioNhanPhongPhieuDatPhong = new JLabel("23:20 - 10/04/2024");
...
//		((DefaultTableCellRenderer) h.getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);
		...
		gl_panel_3.setHorizontalGroup(
			gl_panel_3.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblNewLabel_11, GroupLayout.DEFAULT_SIZE, 1273, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		lblGioNhanPhong = new JLabel("23:20 - 10/04/2024");
		...
		lblThoiLuong = new JLabel(" 120 phút");
		...
		lblMGimGi.addAncestorListener(new AncestorListener() {
			public void ancestorAdded(AncestorEvent event) {
			}
			public void ancestorMoved(AncestorEvent event) {
			}
...
//		System.out.println("MaTTP " + maTTP);
		...
		if (maTTP.equalsIgnoreCase(MainFrame.maPhongCho)) {
			...
			lbGioNhanPhongPhieuDatPhong.setText(FormatCustom.dinhDanhThoiGian(phieuDatPhong.getNgayNhanPhong()));
			Date now = new Date();
...
//				hoaDonDao.themHoacCapNhatChiTietHoaDon(chiTietHoaDonChuyen);
			...
			hoaDonDao.themHoacCapNhatChiTietHoaDon(new ChiTietHoaDon(phong, hoaDon, null));
