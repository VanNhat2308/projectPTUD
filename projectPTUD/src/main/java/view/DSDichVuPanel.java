...
//		setLocationRelativeTo(null);
		...
		danhSachDichVu = dichVuDao.layDanhSachDichVuTheoTenNgayTrangThai(null, 1);
...
public void khoiTao() {
	...
	private void loadDuLieuVaoTable(String text,int selectedIndex) {
		...
		danhSachDichVu = dichVuDao.layDanhSachDichVuTheoTenNgayTrangThai(text, selectedIndex);
