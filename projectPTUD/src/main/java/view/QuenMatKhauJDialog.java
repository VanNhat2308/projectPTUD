...
public class QuenMatKhauJDialog extends JDialog implements ActionListener {
	...
	public QuenMatKhauJDialog() {
		...
		panel.add(lblQunMtKhu);
		 ...
		 lblNewLabel_2.setBounds(42, 147, 124, 30);
		lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 16));
		getContentPane().add(lblNewLabel_2);

		textField = new JTextField();
		textField.setBounds(207, 144, 410, 35);
		...
		lblNewLabel_2_1.setBounds(77, 313, 124, 30);
		lblNewLabel_2_1.setFont(new Font("Tahoma", Font.BOLD, 16));
		getContentPane().add(lblNewLabel_2_1);

		textField_1 = new JPasswordField();
		textField_1.setBounds(207, 223, 410, 35);
		textField_1.setText("");
		...
		lblNewLabel_2_2.setBounds(42, 226, 124, 30);
