...
public class DialogThemKhuyenMai extends JDialog implements ActionListener {
	...
	public DialogThemKhuyenMai() {
		...
		JLabel lblNewLabel_2_2 = new JLabel("Mã khuyến mãi");
		...
		txtMaKhuyenMai.setFont(new Font("Tahoma", Font.PLAIN, 16));
		txtMaKhuyenMai.setBounds(170, 97, 629, 35);
		contentPanel.add(txtMaKhuyenMai);
