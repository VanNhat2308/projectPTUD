...
public class MainFrame extends JMenu implements ActionListener {
	...
	public static String maQuanLy = "NVAA001";
...
//		 setLocationRelativeTo(null);
		...
		mainFrame = new JFrame("Quản lý khách sạn 4 mùa");
//		mainFrame.setIconImage(Toolkit.getDefaultToolkit().getImage(MainFrame.class.getResource("/icon/khachsan.png")));
