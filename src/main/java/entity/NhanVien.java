 ...
 * @param loaiNhanVien
 */
	public NhanVien(String maNV, boolean gioiTinh, String hoTen, Date ngaySinh, String password,
			String soCMND, String soDienThoai, boolean trangThaiLamViec, DiaChi diaChi) {
		super();
		this.maNV = maNV;
