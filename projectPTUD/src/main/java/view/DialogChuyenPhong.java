...
public class DialogChuyenPhong extends JDialog implements ActionListener, MouseListener {
	...
	public DialogChuyenPhong() {
		...
		lblNewLabel.setBounds(-29, 0, 727, 53);
		...
		lblSoPhong.setBounds(218, 77, 65, 30);
		...
		scrollPane.setBounds(10, 171, 649, 270);
		...
		btnChuyen.setBounds(548, 461, 111, 30);
		...
		btnQuayLai.setBounds(10, 461, 111, 30);
		...
		lblSoPhongChuyen.setBounds(218, 118, 65, 30);
		...
		btnLamMoi.setBounds(133, 461, 111, 30);
		...
		lblNewLabel_2 = new JLabel("Phòng chuyển đến: ");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_2.setBounds(10, 118, 188, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (object == btnChuyen) {
			...
			if (phongChuyen.getTrangThaiPhong().equalsIgnoreCase(MainFrame.maPhongCho)) {
