...
//		setVisible(true);
		...
		lblGioLap.setText(FormatCustom.dinhDanhThoiGian(phieuDatPhong.getNgayDKDatPhong()));
		lblGioNhanPhong.setText(FormatCustom.dinhDanhThoiGian(phieuDatPhong.getNgayNhanPhong()));
	}
